...
AddTests('SUMIF', [
  ...
  { type: 'expect', expression: '=SUMIF(B1:B5,"Sales",A1:A5)', expected: 105 },
  { type: 'expect', expression: '=SUMIF(A1:A5,30)', expected: 30 },
], SetRange => {
...
AddTests('SUMIFS', [
  ...
  { type: 'expect', expression: '=SUMIFS(C1:C5,B1:B5,">30")', expected: 120 },
  { type: 'expect', expression: '=SUMIFS(C1:C5,A1:A5,"Sales",B1:B5,"<50")', expected: 50 },
], SetRange => {
