...
AddTests('NORM.INV', [
  ...
  { type: 'approximate', expression: '=NORM.INV(0.8413447461,0,1)', expected: 1, epsilon: 1e-6 },
  { type: 'approximate', expression: '=NORM.INV(0.975,0,1)', expected: 1.959963985, epsilon: 1e-6 },
...
AddTests('NORM.S.DIST', [
  ...
  { type: 'approximate', expression: '=NORM.S.DIST(-1.96,TRUE)', expected: 0.0249978951, epsilon: 1e-6 },
]);

AddTests('NORM.S.INV', [
  { type: 'approximate', expression: '=NORM.S.INV(0.5)', expected: 0, epsilon },
  { type: 'approximate', expression: '=NORM.S.INV(0.975)', expected: 1.959963985, epsilon: 1e-6 },
  { type: 'approximate', expression: '=NORM.S.INV(0.025)', expected: -1.959963985, epsilon: 1e-6 },
  { type: 'approximate', expression: '=NORM.S.INV(0.8413447461)', expected: 1, epsilon: 1e-6 },
]);
