...
AddTests('NPER', [
  ...
  { type: 'approximate', expression: '=NPER(0.1,-100,0,10000)', expected: 7.2725, epsilon: 0.01 },
]);

AddTests('RATE', [
  { type: 'approximate', expression: '=RATE(48,-200,8000)', expected: 0.0077, epsilon: 0.001 },
  { type: 'approximate', expression: '=RATE(60,-1000,50000)', expected: 0.002, epsilon: 0.001 },
]);
